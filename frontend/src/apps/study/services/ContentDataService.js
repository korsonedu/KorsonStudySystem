 ...
 * @returns 当前视图的内容统计数据
 */
export const getContentStatsByView = (currentView, dailyContentStats, weeklyContentStats, monthlyContentStats) => {
    // 打印传入的内容统计数据，用于调试
 ...
 * @returns 内容统计数据
 */
export const generateContentStatsFromTasks = (tasks, startDate, endDate) => {
 ...
 * @returns 今日内容统计数据
 */
export const getDailyContentStats = (tasks) => {
 ...
 * @returns 本周内容统计数据
 */
export const getWeeklyContentStats = (tasks) => {
    const today = new Date();
    // 获取本周的开始日期（周一）- 中国习惯
 ...
 * @returns 本月内容统计数据
 */
export const getMonthlyContentStats = (tasks) => {
    const today = new Date();
    // 获取本月的开始日期
