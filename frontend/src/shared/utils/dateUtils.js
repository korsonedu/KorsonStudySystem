 ...
 * @returns 中国时区的日期对象
 */
export function toChinaTimezone(dateStr) {
 ...
 * @returns 中国时区的当前日期对象
 */
export function getNowInChinaTimezone() {
 ...
 * @returns 中国时区的日期字符串
 */
export function formatDateInChinaTimezone(date) {
 ...
 * @returns 中国时区的时间字符串
 */
export function formatTimeInChinaTimezone(date) {
    const chinaDate = date instanceof Date ? toChinaTimezone(date.toISOString()) : toChinaTimezone(date);
 ...
 */
export function formatDateTimeInChinaTimezone(date) {
    const chinaDate = date instanceof Date ? toChinaTimezone(date.toISOString()) : toChinaTimezone(date);
